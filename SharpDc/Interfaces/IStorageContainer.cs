...
namespace SharpDc.Interfaces
{
    ...
    public abstract class IStorageContainer : IDisposable
    {
        ...
        public abstract bool WriteData(SegmentInfo segment, int offset, byte[] buffer, int length);

        /// <summary>
        ///  Reads data from the saved segment
        ///  Returns amount of bytes read
        ///  </summary><param name="segmentIndex"></param><param name="segmentOffset">segment offset to read from</param><param name="buffer"></param><param name="bufferOffset">buffer write offset</param><param name="count"></param><returns></returns>
        ...
        ///  </summary><param name="segmentIndex"></param><returns></returns>
